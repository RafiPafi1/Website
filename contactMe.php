...
<body>
    ...
    ?>
    <section id="contact">
      <div class="container-fluid border border-3 border-primary bg-light">
          ...
          <div class="col-lg-6">
            <form id="form" method="POST">
              ...
              <div class="mb-4 input-group">
                ...
                <input type="email" class="form-control" id="email" placeholder="e.g. rafal@example.com">
                <!-- Tooltip -->
                <span class="input-group-text">
              ...
              <div class="mb-4 input-group">
                ...
                <input type="text" class="form-control" id="name" placeholder="e.g. Rafal">
                <!-- Tooltip -->
                <span class="input-group-text">
